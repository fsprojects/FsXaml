...
let githubLink = "http://github.com/fsprojects/FsXaml"

// Specify more information about your project
let info =
  [ "project-name", "FsXaml"
    "project-author", "@ReedCopsey"
    "project-summary", "F# Tools for working with XAML Projects"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsXaml" ]
